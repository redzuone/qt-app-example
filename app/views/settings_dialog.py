...
class SettingsDialog(QDialog):
    def __init__(
        self, app_settings: AppSettings, parent: QWidget | None = None
    ) -> None:
        ...
        self._rdf_station_1_longitude_input.setValue(
            app_settings.rdf_station_1_longitude
        )
        ...
        self._rdf_station_1_altitude_input.setValue(
            app_settings.rdf_station_1_altitude_m
        )
        ...
        self._rdf_station_2_longitude_input.setValue(
            app_settings.rdf_station_2_longitude
        )
        ...
        self._rdf_station_2_altitude_input.setValue(
            app_settings.rdf_station_2_altitude_m
        )
        ...
        self._rdf_frequency_tolerance_input.setValue(
            app_settings.rdf_frequency_tolerance_hz
        )
        ...
        self._rdf_distance_tolerance_input.setValue(
            app_settings.rdf_distance_tolerance_m
        )

        form_layout = QFormLayout()
        form_layout.addRow('Sensor centre latitude', self._sensor_center_latitude_input)
        form_layout.addRow(
            'Sensor centre longitude', self._sensor_center_longitude_input
        )
        ...
        form_layout.addRow(
            'RDF station 1 longitude', self._rdf_station_1_longitude_input
        )
        form_layout.addRow(
            'RDF station 1 altitude (m)', self._rdf_station_1_altitude_input
        )
        form_layout.addRow(
        ...
        form_layout.addRow(
            'RDF station 2 longitude', self._rdf_station_2_longitude_input
        )
        form_layout.addRow(
            'RDF station 2 altitude (m)', self._rdf_station_2_altitude_input
        )
        form_layout.addRow(
        ...
        form_layout.addRow(
            'RDF frequency tolerance (Hz)', self._rdf_frequency_tolerance_input
        )
        form_layout.addRow(
            'RDF distance tolerance (m)', self._rdf_distance_tolerance_input
        )
